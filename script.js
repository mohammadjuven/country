let selectBox = document.querySelector('select')
    ...
    let country = [
      {id:1,name:"Russia",src:"1 روسیه.png",ghare:'Europe',capital:'Moscow',text:'Russia is a bigest country in the all of world and the most of this is in Asia and the little part of this is in Europe.usually the weather it is cold.'},
      {id:2,name:"Canada",src:"2 کانادا.png",ghare:'North America',capital:'Otawa'},
      {id:3,name:"China",src:"3 چین.png",ghare:'Asia',capital:'Bejin'},
      {id:4,name:"USA",src:"4 آمریکا.png",ghare:'North America',capital:'Washington'},
      {id:5,name:"Brazil",src:"5 برزیل.png",ghare:'South America',capital:'Brazilia'},
      {id:6,name:"Australia",src:"6 استرالیا.png",ghare:'Asia',capital:'Canbera'},
      {id:7,name:"India",src:"7 هند.png",ghare:'Asia',capital:'Dehlino'},
      {id:8,name:"Argentina",src:"8 آرژانتین.png",ghare:'South America',capital:'Boenus Aires'},
      {id:9,name:"Kazaghestan",src:"9 قزاقستان.png",ghare:'Asia',capital:'Astaneh'},
      {id:10,name:"Algira",src:"10 الجزایر.png",ghare:'Africa',capital:'Aljazire'},
      {id:11,name:"Republic_Kongo",src:"11 کنگو زعیر.png",ghare:'Africa',capital:'Kinshasa'},
      {id:12,name:"SoudiArabia",src:"12 عربستان.png",ghare:'Asia',capital:'Ryiadh'},
      {id:13,name:"Mexico",src:"13 مکزیک.png",ghare:'North America',capital:'Mexico City'},
      {id:14,name:"Indonisia",src:"14 اندونزی.png",ghare:'Asia',capital:'Jakarta'},
      {id:15,name:"Soudan",src:"15 سودان.png",ghare:'Africa',capital:'Khortoom'},
      {id:16,name:"Libia",src:"16 لیبی.png",ghare:'Africa',capital:'Trables'},
      {id:17,name:"Iran",src:"17 ایران.png",ghare:'Asia',capital:'Tehran'},
